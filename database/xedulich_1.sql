...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2014 at 10:38 AM
...
CREATE TABLE IF NOT EXISTS `chitietxe` (
  ...
  `Gia` varchar(32) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
...
(1, 'Honda Civic 1.8 MT', 2009, '123456', 'Bạc', 'car-c1.jpg', 'xe honda 1aaaaaaaaaaaaaaa', '725000000', 1, 1),
(2, 'Honda Civic 1.8 AT', 2009, '949584', 'Đen', 'car-c2.jpg', 'Lưới tản nhiệt với thiết kế 3 nan mới. Nội thất thoải mái và tiện nghi và hiện đại của một căn phòng di động. Màn hình 5 inch hiển thị các thông số chính ở phía trên', '780000000', 1, 1),
(3, 'Honda Civic 2.0 AT', 2010, '546652', 'Đỏ', 'car-c3.jpg', 'Màn hình 5 inch hiển thị các thông số chính ở phía trên. Nút bấm chế độ ECON. Lưới tản nhiệt với thiết kế 3 nan mới', '860000000', 1, 1),
(4, 'Honda City 1.5 MT', 2013, '9449kjl', 'Đen', 'car-c4.jpg', 'Hệ thống điều hòa nhiệt độ. Hệ thống chiếu sáng toàn xe. Hệ thống âm thanh Audio với 4 loa', '540 000 000', 1, 1),
(5, 'Camry 2.5G', 2014, '345345', 'Đen', 'car-c5.jpg', 'Chế độ điều khiển tự động. Công suất tối đa (SAE-Net) 178/6.000 Hp/rpm', '1164000000', 1, 2),
(6, 'Vios 1.5 e', 2014, '123459', 'Bạc', 'car-c6.jpg', 'Đèn sương mù phía trước. Gương chiếu hậu ngoài. Tiêu chuẩn khí xả Euro 4', '552000000', 1, 2),
(7, 'Corolla 1.8 CVT', 2000, '949581', 'Đen', 'car-c7.jpg', 'Hệ thống túi khí. Dây đai an toàn. Tiêu chuẩn khí xả Euro4', '786000000', 2, 2),
(8, 'Audi Q5 2.0 TFSI', 2014, '52AB-1234', 'Bạc', '', 'Khoảng sáng gầm xe 200mm. Vô lăng điều chỉnh 04 hướng - trợ lực lái. Hỗ trợ đổ đèo HDC. Tự động cân bằng điện tử EPS ', '1844000000', 1, 6),
(9, 'Audi R8 V10', 2013, '12AB-4321', 'Lam', '', 'PPI Speed Design GmbH đầu tiên tập trung vào động cơ 10 xi-lanh, lập trình lại bộ ECU và lắp đặt hệ thống ống xả mới. Công suất vọt lên mức 621 mã lực tại vòng tua máy 7.400 vòng/phút và mô-men xoắn cực đại 565 Nm tại 6.400 vòng/phút. Kết quả của sự thay ', '4100000000', 1, 6),
(10, 'Audi A4', 2013, '34BC-0987', 'Đen', '', 'PPI Speed Design GmbH đầu tiên tập trung vào động cơ 10 xi-lanh, lập trình lại bộ ECU và lắp đặt hệ thống ống xả mới. Công suất vọt lên mức 621 mã lực tại vòng tua máy 7.400 vòng/phút và mô-men xoắn cực đại 565 Nm tại 6.400 vòng/phút', '1460000000', 2, 6),
(11, 'Kia Optima', 2012, '43NB-1234', 'Đỏ', '', 'Tay lái trợ lực. Đèn chiếu sương mù', '960000000', 1, 8),
(12, 'Kia Rio 5-door', 2013, 'OL42-4344', 'Bạc', '', 'Hộp số: số tự động 4 cấp. Dẫn động 1 cầu. Dung tích xi lanh: 1.396', '0', 1, 8),
(13, 'Mitsubishi Triton GL', 2012, '85AB-9999', 'Trắng', '', 'Khoảng sáng gầm xe 200mm. Truyền động 2 cầu. Dung tích xi lanh: 2.351', '482.300.000', 2, 7),
(14, 'Pajero GL', 2013, 'GH67-7777', 'Trắng', '', 'Nắp capô được thay thế bằng vật liệu nhôm hợp kim đã giảm được trọng lượng khoảng 9kg cũng như cải thiện phân bố trọng lượng trước/sau, ngoài ra còn giúp cho việc đóng/mở nắp capô nhẹ nhàng hơn', '1.790.900.000', 3, 7),
(15, 'Canter HD', 2012, 'JK90-0009', 'Vàng', '', 'Hộp số: 5 số tiến và 1 số lùi', '630.000.000', 2, 7),
(16, 'Hyundai grand starex', 2013, 'UT23-2323', 'Bạc', '', 'Mâm đúc 16, bánh xe sơ cua mâm sắt. Dung tích nhiên liệu : 75 (lít).', '825 000 000', 7, 4),
(17, 'Hyundai starex 2.4', 2011, '98GV-1234', 'Trắng', '', 'Lưới tản nhiệt mạ Crôm; Cửa hậu mở lên đèn; Kính màu', '760000000', 6, 7);
