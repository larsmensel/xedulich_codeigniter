    ...
    <div class="navbar-default navbar-static-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
          ...
          <li> <a href="<?php echo base_url(); ?>tintuc"><i class="fa fa-bar-chart-o fa-fw"></i> Quản lý tin tức</a></li>
          <li> <a href="<?php echo base_url(); ?>donhang"><i class="fa fa-bar-chart-o fa-fw"></i> Quản lý đơn hàng</a></li>
          <?php /*?><li> <a href="<?php echo base_url(); ?>khachhang"><i class="fa fa-bar-chart-o fa-fw"></i> Quản lý khách hàng</a></li>
          <li> <a href="<?php echo base_url(); ?>user"><i class="fa fa-bar-chart-o fa-fw"></i> Quản lý user</a></li><?php */?>
          <li> <a href="<?php echo base_url(); ?>home/thoat"><i class="fa fa-sign-out fa-fw"></i> Thoát</a> </li>
        </ul>
        <!-- /#side-menu --> 
      </div>
      <!-- /.sidebar-collapse --> 
