    ...
    <div class="navbar-default navbar-static-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
          ...
          <li> <a href="<?php echo base_url(); ?>xe/chitietxe"><i class="fa fa-bar-chart-o fa-fw"></i> Chi Tiết Xe</a></li>
          <li> <a href="<?php echo base_url(); ?>tintuc/chitiettintuc"><i class="fa fa-bar-chart-o fa-fw"></i> Chi Tiết Tin Tức</a></li>
