...
<div class="tt-main-left">
  <div class="tt-box-style">
    <h2 class="tt-box-style-tt"><?php echo $title; ?></h2>
    <ul class="tt-box-grids">
	  ...
	  ?>
      <li> <a href="<?php echo base_url().'xe_detail/'.$IDchitietxe; ?>" class="pull-left"><img src="<?php echo base_url().'upload/'.$UrlHinh;?>" width="150" height="110"></a>
